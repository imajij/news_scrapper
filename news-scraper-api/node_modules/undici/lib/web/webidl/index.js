...
webidl.is.ReadableStream = typeof ReadableStream !== 'undefined'
  ? webidl.util.MakeTypeAssertion(ReadableStream)
  : () => false
webidl.is.Blob = typeof Blob !== 'undefined'
  ? webidl.util.MakeTypeAssertion(Blob)
  : () => false
webidl.is.URLSearchParams = typeof URLSearchParams !== 'undefined'
  ? webidl.util.MakeTypeAssertion(URLSearchParams)
  : () => false
webidl.is.File = typeof File !== 'undefined'
  ? webidl.util.MakeTypeAssertion(File)
  : () => false
webidl.is.URL = typeof URL !== 'undefined'
  ? webidl.util.MakeTypeAssertion(URL)
  : () => false
webidl.is.AbortSignal = typeof AbortSignal !== 'undefined'
  ? webidl.util.MakeTypeAssertion(AbortSignal)
  : () => false
webidl.is.MessagePort = typeof MessagePort !== 'undefined'
  ? webidl.util.MakeTypeAssertion(MessagePort)
  : () => false
